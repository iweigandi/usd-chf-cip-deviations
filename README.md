...
The script downloads public data, computes the monthly series, writes diagnostics, and regenerates the chart. A GitHub Action can run the same pipeline on a schedule.
